import EntertainmentImage from "../assets/projects/entertainment.jpg";
import DictionaryImage from "../assets/projects/dictionary.jpg";
    ...
    <div className="flex flex-col items-center gap-4">
      ...
      <div className="flex flex-row gap-7">
        <a
          ...
          href={repoLink}
        >
          Code <img src={GithubLogo} className="w-5" />
        </a>
        <a
          className="flex flex-row items-center gap-2 font-medium"
          href={demoLink}
        >
          Demo <img src={ExtLinkIcon} className="w-5" />
        </a>
      </div>
    </div>
  );
